...
public class CallbackDetailsPage extends WebDriverUtils {
	...
	public CallbackDetailsPage(WebDriver driver)
	{
	...
	public void addcallBack()
	{
		...
		customer.click();
		SearchCustomer.sendKeys("subir sarkar",Keys.ENTER);
		CallbackDate.click();
		CallbackDate.sendKeys("01:06  02/09/2020");
