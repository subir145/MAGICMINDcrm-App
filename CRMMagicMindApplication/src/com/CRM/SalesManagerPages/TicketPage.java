...
public class TicketPage extends WebDriverUtils {
	...
	{
		AddTicket.click();
		TicketSubject.sendKeys("The functionality ids not working properly ");
	}
	public void clickdesc()
	{
		
		Desc.sendKeys("please follow the description before use");
	}
	
	public void clickassSubmit()
	{
		AssignedTo.click();
		AssignSearch.sendKeys("am@test",Keys.ENTER);
	}
	
	public void clickUploadFile(WebDriver driver) throws IOException
	{
		JavascriptExecutor jse=(JavascriptExecutor)driver;
		jse.executeScript("arguments[0].click();",UploadFile);
		
		
		Runtime.getRuntime().exec("C://autoitfiles/fileupload.exe"+ " "+"D:\\Extra\\chakan bosari.oxps");
		
	}
	public void clickAddTicketSubmit()
	{
		submit.click();
	}
...
//		sel.selectByVisibleText("Manager-(manager@test.com");
		...
		SearchReAssign.sendKeys("Manager",Keys.ENTER);
	}
